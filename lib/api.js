...
export const fetchDailyReport = async () => {
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/daily-report/`);
  ...
  export const fetchWeeklyReport = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/weekly-report/`);
      return response.data.report;
    } catch (error) {
...
export const fetchDailyClosingPrices = async () => {
    const response = await axios.get(`${API_BASE_URL}/daily-closing-price/`);
    return response.data;
};
...
export const fetchPriceChangePercentage = async (period) => {
  ...
  const url = `${API_BASE_URL}/price-change-percentage/?period=${validPeriod}`;
...
export const fetchTopGainersLosers = async (isGainer) => {
    try {
        const response = await axios.get(`${API_BASE_URL}/top-gainers-losers/`, {
